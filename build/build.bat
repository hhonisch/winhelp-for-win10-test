...
echo.
echo *** Exporting Release\WinHelpProxy.exe to %BIN_DIR%\x86...
mkdir "%BIN_DIR%\x86"
...
echo.
echo *** Exporting x64\Release\WinHelpProxy.exe to %BIN_DIR%\x64...
mkdir "%BIN_DIR%\x64"
...
echo *** Exporting %INSTALLER_EXE% to %DIST_DIR%...
